                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-body">
                            ...
                            <form action="{{ route('pemesanan-armada.update', $armada->id) }}" method="post"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10 col-12 ">
                                        <input type="date" name="nama" id="nama" class="form-control"
                                            placeholder="contoh: Eva PT Maju Jaya " value="{{ $pemesanan->pemesanan_name }}" required>
                                        @error('nama')
                                        ...
                                        <select name="jenis_kendaraan" class="form-control" required>
                                            @foreach ($armada as $item)
                                                <option value="{{ $item->jenis_kendaraan }}"
                                                    {{ $pemesanan->jenis_kendaraan == {{ $item->jenis_kendaraan }} ? 'selected' : '' }}>{{ $item->jenis_kendaraan }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10 col-12 ">
                                        <input type="date" name="tanggal_pemesanan" id="tanggal_pemesanan"
                                            class="form-control" value="{{ $pemesanan->tanggal_pemesanan }}" required>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10 col-12 ">
                                        <input type="date" name="detail_barang" id="detail_barang" class="form-control"
                                            placeholder="contoh: Lemari " value="{{ $pemesanan->detail_barang }}" required>
                                        @error('detail_barang')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
