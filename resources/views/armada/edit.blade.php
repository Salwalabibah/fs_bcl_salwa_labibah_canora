                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10 col-12 ">
                                        <input type="text" name="nomor_kendaraan" id="nomor_kendaraan"
                                            ...
                                            value="{{ $armada->nomor_kendaraan }}" required>
                                    ...
                                    <div class="col-md-10 col-12">
                                        <select name="jenis_kendaraan" class="form-control" required>
                                            ...
                                            <option value="Truck Box"
                                                {{ $armada->jenis_kendaraan == 'Truck Box' ? 'selected' : '' }}>Truck Box
                                            </option>
                                            <option value="Pick Up"
                                                {{ $armada->jenis_kendaraan == 'Pick Up' ? 'selected' : '' }}>
                                                Pick Up
                                            </option>
                                        </select>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10 col-12">
                                        <select name="status_ketersediaan" class="form-control" required>
                                            <option value="1"
                                                {{ $armada->status_ketersediaan == '1' ? 'selected' : '' }}>Tersedia
                                            </option>
                                            <option value="0"
                                                {{ $armada->status_ketersediaan == '0' ? 'selected' : '' }}>
                                                Tidak Tersedia
                                            </option>
                                        </select>
